...
cryptsetup luksHeaderBackup "$P3" --header-backup-file "$OUTDIR/cryptswap-luks2-header-$STAMP.img"
cryptsetup luksHeaderBackup "$P4" --header-backup-file "$OUTDIR/cryptroot-luks2-header-$STAMP.img"
